...
public:
	...
	SettingsParseEvent parseConfigObject(const std::string &line, const std::string &end,
			std::string &name, std::string &value);
	bool updateConfigObject(std::istream &is, std::ostream &os, const std::string &end,
			u32 tab_depth = 0);
	...
	bool setEntry(
			const std::string &name, const void *entry, bool set_group, bool set_default);
	...
	bool setNoiseParams(
			const std::string &name, const NoiseParams &np, bool set_default = false);
	...
	void registerChangedCallback(
			const std::string &name, SettingsChangedCallback cbf, void *userdata = NULL);
	void deregisterChangedCallback(
			const std::string &name, SettingsChangedCallback cbf, void *userdata = NULL);
