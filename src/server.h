...
public:
	...
	*/
	...
	bool showFormspec(
			const char *name, const std::string &formspec, const std::string &formname);
	...
	bool getClientInfo(session_t peer_id, ClientState *state, u32 *uptime, u8 *ser_vers,
			u16 *prot_vers, u8 *major, u8 *minor, u8 *patch, std::string *vers_string,
...
private:
	...
	void broadcastModChannelMessage(
	...
	*/
	...
	void sendAddNode(v3s16 p, MapNode n, std::unordered_set<u16> *far_players = nullptr,
