...
#ifndef GUIFORMSPECMENU_V1_HEADER
#define GUIFORMSPECMENU_V1_HEADER
...
class guiFormSpecMenu_v1 : public guiFormSpecBase
{
	struct ItemSpec
	{
		ItemSpec()
...
public:
	guiFormSpecMenu_v1(irr::IrrlichtDevice* dev,
	...
	// form_src is deleted by this guiFormSpecMenu_v1
	...
	// text_dst is deleted by this guiFormSpecMenu_v1
