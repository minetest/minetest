...
{
	union {char b[4]; u32 i;} bo = {{1, 2, 3, 4}};
	if (bo.i != 0x04030201) {
		warningstream << "Byte order is not little endian, skipping test.";
		return;
	}
...
const u8 TestRandom::expected_pcgrandom_bytes_result[24] = {
	0xf3, 0x79, 0x8f, 0xac, 0xd9, 0x34, 0xf8, 0x3c, 0x6e, 0x82, 0x37, 0x6b,
	0x4b, 0x77, 0xe3, 0xbd, 0x0a, 0xee, 0x22, 0x79, 0x6e, 0x40, 0x4f, 0x00,
};
