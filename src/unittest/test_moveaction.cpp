...
public:
	...
	void testMoveSomewherePartial(MockServerActiveObject *obj, IGameDef *gamedef);
...
void TestMoveAction::testMoveSomewherePartial(MockServerActiveObject *obj, IGameDef *gamedef)
{
