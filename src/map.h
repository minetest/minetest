...
public:
	...
	*/
	...
	MapNode getNodeNoEx(const v3s16 &p, bool *is_valid_position = NULL);
	...
	*/
	bool addNodeWithEvent(const v3s16 &p, MapNode n, bool remove_metadata = true);
	...
	*/
	 ...
	 */
	bool setNodeMetadata(const v3s16 &p, NodeMetadata *meta);
	...
	*/
	...
	bool isBlockOccluded(MapBlock *block, const v3s16 &cam_pos_nodes);
protected:
...
public:
	...
	*/
	...
	bool initBlockMake(const v3s16 &blockpos, BlockMakeData *data);
	...
	*/
	...
	void updateVManip(const v3s16 &pos);
	 ...
	 */
	bool repairBlockLight(const v3s16 &blockpos,
		std::map<v3s16, MapBlock *> *modified_blocks);
