...
fake_function() {
	...
	gettext("0 = parallax occlusion with slope info (faster).\n1 = relief mapping (slower, more accurate).");
	...
	gettext("Formspec fullscreen background opacity");
	gettext("Formspec fullscreen background opacity (between 0 and 255).");
	gettext("Formspec fullscreen background color");
	gettext("Formspec fullscreen background color (R,G,B).");
	...
	gettext("Kick players sending more than X messages per 10 seconds.");
	gettext("Physics");
	...
	gettext("How long the server will wait before unloading unused MapBlocks.\nHigher value is smoother, but will use more RAM.");
	...
	gettext("Interval for active block management");
	gettext("Time in between active block management cycles");
	gettext("Interval for active block modifier");
