...
fake_function() {
	...
	gettext("Network");
	gettext("Listen addresses");
	gettext("Network addresses and ports to listen on.\nIPV6_V6ONLY is set on all IPv6 addresses.");
	gettext("Bind address");
	gettext("Network address to bind to when making outgoing connections.\nIf you're running a server and have announcing enabled the\nserver should also listen on this address.");
