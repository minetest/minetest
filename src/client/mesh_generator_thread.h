...
public:
	...
	void addBlock(Map *map, const v3s16 &p, bool ack_block_to_server, bool urgent);
...
private:
	...
	CachedMapBlockData *cacheBlock(Map *map, const v3s16 &p, UpdateMode mode,
...
public:
	...
	// Caches the block at p and its neighbors (if needed) and queues a mesh
	// update for the block at p
	void updateBlock(Map *map, const v3s16 &p, bool ack_block_to_server, bool urgent);
