...
public:
	...
	void print(std::ostream &o)
	{
		for (const auto &m_packet : m_packets) {
			o << "cmd " << m_packet.first << " count " << m_packet.second
			  << std::endl;
		}
	}
...
public:
	...
	*/
	...
	u16 getPlayerItem() const { return m_playeritem; }
	...
	bool itemdefReceived() { return m_itemdef_received; }
	bool nodedefReceived() { return m_nodedef_received; }
	bool mediaReceived() { return !m_media_downloader; }
