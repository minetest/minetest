...
v3POS MapNode::getWallMountedDir(const NodeDefManager *nodemgr) const
{
...
static inline void getNeighborConnectingFace(
	const v3POS &p, const NodeDefManager *nodedef,
...
u8 MapNode::getNeighbors(v3POS p, Map *map) const
{
