		...
		SourceShaderCache *sourcecache)
{
	...
	switch(material_type){
		...
		case TILE_MATERIAL_WAVING_WATER_BASIC:
		...
		case TILE_MATERIAL_WAVING_WATER_TRANSPARENT:
			shaderinfo.base_material = video::EMT_TRANSPARENT_ALPHA_CHANNEL;
			break;
		case TILE_MATERIAL_LIQUID_OPAQUE:
		case TILE_MATERIAL_WAVING_WATER_OPAQUE:
	...
	static const char* materialTypes[] = {
		...
		"TILE_MATERIAL_WAVING_WATER_BASIC",
		"TILE_MATERIAL_WAVING_WATER_TRANSPARENT",
		"TILE_MATERIAL_WAVING_WATER_OPAQUE"
	};
