...
guiFormSpecMenu_v2::guiFormSpecMenu_v2(irr::IrrlichtDevice* dev,
		gui::IGUIElement* parent, s32 id, IMenuManager *menumgr,
		InventoryManager *invmgr, IGameDef *gamedef,
		ISimpleTextureSource *tsrc, IFormSource* fsrc, TextDest* tdst,
		Client* client) :
	guiFormSpecBase(dev, parent, id, menumgr, invmgr, gamedef, tsrc, fsrc, tdst, client),
...
guiFormSpecMenu_v2::~guiFormSpecMenu_v2()
{
	removeChildren();
...
void guiFormSpecMenu_v2::removeChildren()
{
...
void guiFormSpecMenu_v2::setInitialFocus()
{
...
GUITable* guiFormSpecMenu_v2::getTable(std::wstring tablename)
{
	for (u32 i = 0; i < m_tables.size(); ++i) {
...
void guiFormSpecMenu_v2::parseSize(parserData* data,std::string element)
{
...
void guiFormSpecMenu_v2::parseList(parserData* data,std::string element)
{
	if (m_gamedef == 0) {
...
void guiFormSpecMenu_v2::parseCheckbox(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseScrollBar(parserData* data, std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseImage(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseItemImage(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseButton(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseBackground(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTableOptions(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTableColumns(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTable(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTextList(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseDropDown(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parsePwdField(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseSimpleField(parserData* data,
...
void guiFormSpecMenu_v2::parseTextArea(parserData* data,
...
void guiFormSpecMenu_v2::parseField(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseLabel(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseVertLabel(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseImageButton(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTabHeader(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseItemImageButton(parserData* data,std::string element)
{
...
void guiFormSpecMenu_v2::parseBox(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseBackgroundColor(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseListColors(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v2::parseTooltip(parserData* data, std::string element)
{
	std::vector<std::string> parts = split(element,';');
	if (parts.size() == 2) {
		std::string name = parts[0];
...
bool guiFormSpecMenu_v2::parseVersionDirect(std::string data)
{
	//some prechecks
	if (data == "")
		return false;
...
bool guiFormSpecMenu_v2::parseSizeDirect(parserData* data, std::string element)
{
	if (element == "")
		return false;
...
void guiFormSpecMenu_v2::parseElement(parserData* data, std::string element)
{
	//some prechecks
	if (element == "")
		return;
...
void guiFormSpecMenu_v2::regenerateGui(v2u32 screensize)
{
...
#ifdef __ANDROID__
bool guiFormSpecMenu_v2::getAndroidUIInput()
{
	/* no dialog shown */
...
guiFormSpecMenu_v2::ItemSpec guiFormSpecMenu_v2::getItemAtPos(v2s32 p) const
{
...
void guiFormSpecMenu_v2::drawList(const ListDrawSpec &s, int phase)
{
	video::IVideoDriver* driver = Environment->getVideoDriver();

	Inventory *inv = m_invmgr->getInventory(s.inventoryloc);
	if(!inv){
		infostream<<"guiFormSpecMenu_v2::drawList(): WARNING: "
...
void guiFormSpecMenu_v2::drawSelectedItem()
{
	if(!m_selected_item)
		return;
...
void guiFormSpecMenu_v2::drawMenu()
{
	if(m_form_src){
	...
	*/
	for(u32 i=0; i<m_backgrounds.size(); i++)
	{
		...
		if (texture != 0) {
			...
			errorstream << "guiFormSpecMenu_v2::drawMenu() Draw backgrounds unable to load texture:" << std::endl;
	...
	*/
	for(u32 i=0; i<m_images.size(); i++)
	{
		...
		if (texture != 0) {
			...
			errorstream << "guiFormSpecMenu_v2::drawMenu() Draw images unable to load texture:" << std::endl;
			errorstream << "\t" << spec.name << std::endl;
		}
	}
...
void guiFormSpecMenu_v2::updateSelectedItem()
{
...
ItemStack guiFormSpecMenu_v2::verifySelectedItem()
{
	// If the selected stack has become empty for some reason, deselect it.
	// If the selected stack has become inaccessible, deselect it.
	// If the selected stack has become smaller, adjust m_selected_amount.
...
void guiFormSpecMenu_v2::acceptInput(FormspecQuitMode quitmode=quit_mode_no)
{
	if(m_text_dst)
	{
...
bool guiFormSpecMenu_v2::preprocessEvent(const SEvent& event)
{
	...
	if (event.EventType == EET_TOUCH_INPUT_EVENT)
	{
		...
		if (!root) {
			errorstream
			<< "guiFormSpecMenu_v2::preprocessEvent unable to get root element"
			<< std::endl;
			return false;
		}
		...
		if (event.TouchInput.touchedCount == 1) {
			switch (event.TouchInput.Event) {
				...
				default:
					...
					errorstream
					<< "guiFormSpecMenu_v2::preprocessEvent unexpected usecase Event="
		...
		/* ignore unhandled 2 touch events ... accidental moving for example */
			...
			errorstream
			<< "guiFormSpecMenu_v2::preprocessEvent to many multitouch events "
...
/******************************************************************************/
bool guiFormSpecMenu_v2::DoubleClickDetection(const SEvent event)
{
	if (event.MouseInput.Event == EMIE_LMOUSE_PRESSED_DOWN) {
...
bool guiFormSpecMenu_v2::OnEvent(const SEvent& event)
{
	if(event.EventType==EET_KEY_INPUT_EVENT) {
		KeyPress kp(event.KeyInput);
	...
	if(event.EventType==EET_GUI_EVENT) {
		...
		if(event.GUIEvent.EventType==gui::EGET_ELEMENT_FOCUS_LOST
			...
			if(!canTakeFocus(event.GUIEvent.Element)) {
				infostream<<"guiFormSpecMenu_v2: Not allowing focus change."
						<<std::endl;
 ...
 */
std::wstring guiFormSpecMenu_v2::getNameByID(s32 id)
{
	for(std::vector<FieldSpec>::iterator iter =  m_fields.begin();
				iter != m_fields.end(); iter++) {
		if (iter->fid == id) {
 ...
 */
std::wstring guiFormSpecMenu_v2::getLabelByID(s32 id)
{
	for(std::vector<FieldSpec>::iterator iter =  m_fields.begin();
				iter != m_fields.end(); iter++) {
		if (iter->fid == id) {
