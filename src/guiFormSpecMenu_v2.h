...
#ifndef GUIFORMSPEC_MENU_V2_HEADER
#define GUIFORMSPEC_MENU_V2_HEADER

#include "guiFormSpecMenu.h"
#include "log.h"


class guiFormSpecMenu_v2 : public guiFormSpecBase
{
public:
	guiFormSpecMenu_v2(irr::IrrlichtDevice* dev,
	...
	void lockSize(bool lock,v2u32 basescreensize=v2u32(0,0)) {
		errorstream
				<< "guiFormSpecMenu_v2:lockSize: fixed size forms are deprecated"
				<< " and not implemented by v2" << std::endl;
	}
