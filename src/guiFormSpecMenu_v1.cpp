...
guiFormSpecMenu_v1::guiFormSpecMenu_v1(irr::IrrlichtDevice* dev,
...
guiFormSpecMenu_v1::~guiFormSpecMenu_v1()
{
	removeChildren();
...
void guiFormSpecMenu_v1::removeChildren()
{
...
void guiFormSpecMenu_v1::setInitialFocus()
{
...
GUITable* guiFormSpecMenu_v1::getTable(std::wstring tablename)
{
	for (u32 i = 0; i < m_tables.size(); ++i) {
...
void guiFormSpecMenu_v1::parseSize(parserData* data,std::string element)
{
...
void guiFormSpecMenu_v1::parseList(parserData* data,std::string element)
{
	if (m_gamedef == 0) {
...
void guiFormSpecMenu_v1::parseCheckbox(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseScrollBar(parserData* data, std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseImage(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseItemImage(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseButton(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseBackground(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTableOptions(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTableColumns(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTable(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTextList(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseDropDown(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parsePwdField(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseSimpleField(parserData* data,
...
void guiFormSpecMenu_v1::parseTextArea(parserData* data,
...
void guiFormSpecMenu_v1::parseField(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseLabel(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseVertLabel(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseImageButton(parserData* data,std::string element,
		std::string type)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTabHeader(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseItemImageButton(parserData* data,std::string element)
{
...
void guiFormSpecMenu_v1::parseBox(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseBackgroundColor(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseListColors(parserData* data,std::string element)
{
	std::vector<std::string> parts = split(element,';');
...
void guiFormSpecMenu_v1::parseTooltip(parserData* data, std::string element)
{
	std::vector<std::string> parts = split(element,';');
	if (parts.size() == 2) {
		std::string name = parts[0];
...
bool guiFormSpecMenu_v1::parseVersionDirect(std::string data)
{
	//some prechecks
	if (data == "")
		return false;
...
void guiFormSpecMenu_v1::parseElement(parserData* data, std::string element)
{
	//some prechecks
	if (element == "")
		return;
...
void guiFormSpecMenu_v1::regenerateGui(v2u32 screensize)
{
	parserData mydata;
...
guiFormSpecMenu_v1::ItemSpec guiFormSpecMenu_v1::getItemAtPos(v2s32 p) const
{
...
void guiFormSpecMenu_v1::drawList(const ListDrawSpec &s, int phase)
{
	...
	if(!inv){
		infostream<<"guiFormSpecMenu_v1::drawList(): WARNING: "
...
void guiFormSpecMenu_v1::drawSelectedItem()
{
	if(!m_selected_item)
		return;
...
void guiFormSpecMenu_v1::drawMenu()
{
	if(m_form_src){
	...
	*/
	for(u32 i=0; i<m_backgrounds.size(); i++)
	{
		...
		if (texture != 0) {
			...
			errorstream << "guiFormSpecMenu_v1::drawMenu() Draw backgrounds unable to load texture:" << std::endl;
	...
	*/
	for(u32 i=0; i<m_images.size(); i++)
	{
		...
		if (texture != 0) {
			...
			errorstream << "guiFormSpecMenu_v1::drawMenu() Draw images unable to load texture:" << std::endl;
			errorstream << "\t" << spec.name << std::endl;
		}
	}
...
void guiFormSpecMenu_v1::updateSelectedItem()
{
...
ItemStack guiFormSpecMenu_v1::verifySelectedItem()
{
	// If the selected stack has become empty for some reason, deselect it.
	// If the selected stack has become inaccessible, deselect it.
	// If the selected stack has become smaller, adjust m_selected_amount.
...
void guiFormSpecMenu_v1::acceptInput(FormspecQuitMode quitmode=quit_mode_no)
{
	if(m_text_dst)
	{
...
bool guiFormSpecMenu_v1::preprocessEvent(const SEvent& event)
{
...
/******************************************************************************/
bool guiFormSpecMenu_v1::DoubleClickDetection(const SEvent event)
{
	if (event.MouseInput.Event == EMIE_LMOUSE_PRESSED_DOWN) {
...
bool guiFormSpecMenu_v1::OnEvent(const SEvent& event)
{
	if(event.EventType==EET_KEY_INPUT_EVENT) {
		KeyPress kp(event.KeyInput);
	...
	if(event.EventType==EET_GUI_EVENT) {
		...
		if(event.GUIEvent.EventType==gui::EGET_ELEMENT_FOCUS_LOST
			...
			if(!canTakeFocus(event.GUIEvent.Element)) {
				infostream<<"guiFormSpecMenu_v1: Not allowing focus change."
						<<std::endl;
