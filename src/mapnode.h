...
struct MapNode
{
	...
	*/
	 ...
	 */
	u8 getLightRaw(enum LightBank bank, const ContentFeatures &f) const noexcept;
	...
	*/
	void getSelectionBoxes(INodeDefManager *nodemg, std::vector<aabb3f> *boxes, u8 neighbors = 0) const;

	/*
		Gets list of collision boxes
	*/
	void getCollisionBoxes(INodeDefManager *nodemgr, std::vector<aabb3f> *boxes, u8 neighbors = 0) const;
