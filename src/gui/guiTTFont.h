...
class CGUITTFont : public IGUIFont
{
	public:
		...
		virtual core::dimension2d<u32> getDimension(const ustring& text) const;

		//! Calculates the index of the character in the text which is on a specific position.
		virtual s32 getCharacterFromPos(const wchar_t* text, s32 pixel_x) const;
		virtual s32 getCharacterFromPos(const ustring& text, s32 pixel_x) const;
		...
		virtual void setInvisibleCharacters(const ustring& s);
