...
Library specific options:
    ...
    FREETYPE_INCLUDE_DIR_freetype2  - Only if building with FreeType 2; directory that contains a FreeType directory with files such as ftimage.h in it
...
* Steps:
	...
	* Download all the other stuff to DIR and extract them into there.
	  ("extract here", not "extract to packagename/")
	    ...
	    * NOTE: You need to extract sqlite3.h & sqlite3ext.h from the SQLite 3 source
	      and sqlite3.dll & sqlite3.def from precompiled binaries of SQLite 3 
