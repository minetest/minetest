...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	generate_ore("default:stone_with_coal", "default:stone", minp, maxp, seed+3, 1/8/8/8,    5, 200, 31000 ) -- for float islands and far scaled mountains
	generate_ore("default:stone_with_iron", "default:stone", minp, maxp, seed+4, 1/9/9/9,    5, 200, 31000 )
