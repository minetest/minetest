...
minetest.register_node("basenodes:alarm_clock", {
	...
	tiles = {
		"basenodes_plastic_material.png^[multiply:green",
		"basenodes_metal_material.png",
		"basenodes_digital_dial.png",
		"basenodes_glass_material.png"
	},
	use_texture_alpha = "blend",
	collision_box = {
		type = "fixed",
		fixed = {-0.25, -0.5, -0.175, 0.25, 0.1, 0.175}
	},
	selection_box = {
		type = "fixed",
		fixed = {-0.25, -0.5, -0.175, 0.25, 0.1, 0.175}
...
minetest.register_node("basenodes:papyrus", {
	description = "Papyrus",
	drawtype = "plantlike",
	visual_scale = {x=0.8, y=1.3, z=0.8},
...
minetest.register_node("basenodes:ladder_wood", {
	description = "Wooden Ladder",
	drawtype = "signlike",
	visual_scale = {x=0.9, y=2.0, z=1.2},
...
minetest.register_node("basenodes:torch", {
	description = "Torch",
	drawtype = "torchlike",
