...
local force_load_block = core.force_load_block
local force_load_free_block = core.force_load_free_block
core.force_load_block = nil
core.force_load_free_block = nil
...
function core.force_load_block(pos, transient)
...
function core.force_load_free_block(pos, transient)
	local blockpos = get_blockpos(pos)
	local hash = core.hash_node_position(blockpos)
	local relevant_table, other_table = get_relevant_tables(transient)
...
local wpath = core.get_world_path()
