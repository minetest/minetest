...
describe("vector", function()
	describe("new()", function()
		it("constructs", function()
			...
			assert.is_true(vector.is(vector.new()))
			assert.is_true(vector.is(vector.new(1, 2, 3)))
			assert.is_true(vector.is(vector.new({x = 3, y = 2, z = 1})))
	...
	it("metatable is same", function()
		...
		assert.equal(true, vector.is(a))
		assert.equal(true, vector.is(b))
	...
	it("is()", function()
		...
		assert.is_false(vector.is(nil))
		assert.is_false(vector.is(1))
		assert.is_false(vector.is(true))
		assert.is_false(vector.is("foo"))
		assert.is_false(vector.is(some_table1))
		assert.is_false(vector.is(some_table2))
		assert.is_false(vector.is(some_table3))
		assert.is_false(vector.is(some_table4))
		assert.is_false(vector.is(old))
		assert.is_true(vector.is(real))
		assert.is_true(real:is())
	end)
