...
local function get_formspec(tabview, name, tabdata)
	...
	if tabdata.fav_selected then
		retval = retval .. "field[0.15,5;7,1;search;;".. (menudata.favorites[tabdata.fav_selected].name or "") ..";false]"
	else
		retval = retval .. "field[0.15,5;7,1;search;;;false]"
	end
...
local function main_button_handler(tabview, fields, name, tabdata)
	...
	if fields.btn_search or fields.key_enter_field == "search" then
