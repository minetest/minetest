...
local function get_formspec(dialogdata)
	local markup = table.concat({
		"<big>", fgettext("Luanti Game is no longer installed by default"), "</big>\n",
		fgettext("For a long time, the Luanti engine shipped with a default game called \"Minetest Game\". " ..
				"Since Minetest 5.8.0, Luanti ships without a default game."), "\n",
