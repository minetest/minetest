...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		local hypertext = {
			"<tag name=heading color=#daf>",
			"<tag name=gray color=#a8b>",
		}

		local credits = get_credits()

		table.insert_all(hypertext, {
			"<heading>", fgettext_ne("Opal Client Developers"), "</heading>\n",
		})
		...
		local fs = "image[1.5,0.6;2.5,2.5;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"button_url[1.5,4.1;2.5,0.8;github;OpalClient Github;https://github.com/Python-Sargent/OpalClient]" ..
			"button_url[1.5,5.1;2.5,0.8;minetest_home;Minetest.net;https://www.minetest.net/]" ..
			"hypertext[5.5,0.25;9.75,8.6;credits;" .. minetest.formspec_escape(hypertext) .. "]"

		-- Render information
		local active_renderer_info = fgettext("Active renderer:") .. " " ..
			core.formspec_escape(core.get_active_renderer())
		fs = fs .. "style[label_button2;border=false]" ..
			"button[0.1,7;5.3,0.5;label_button2;" .. active_renderer_info .. "]"..
		...
		fs = fs .. "style[label_button3;border=false]" ..
			"button[0.1,7.5;5.3,0.5;label_button3;" .. irrlicht_device_info .. "]"..
			"tooltip[label_button3;" .. irrlicht_device_info .. "]"

		if PLATFORM == "Android" then
			fs = fs .. "button[1.5,6.1;2.5,0.8;share_debug;" .. fgettext("Share Debug") .. "]"
		else
			fs = fs .. "tooltip[userdata;" ..
					fgettext("Opens the directory that contains user-provided worlds, games, mods,\n" ..
							"and texture packs in a file manager / explorer.") .. "]"
			fs = fs .. "button[1.5,6.1;2.5,0.8;userdata;" .. fgettext("User Data") .. "]"
		end
