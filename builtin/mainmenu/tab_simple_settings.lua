...
local function formspec(tabview, name, tabdata)
	...
	if PLATFORM ~= "Android" then
		...
		"button[8,5;3.75,0.4;btn_change_keys;".. fgettext("Change keys") .. "]"
	else
		tab_string = tab_string ..
		"button[8,5;3.75,0.4;btn_reset_singleplayer;".. fgettext("Reset singleplayer world") .. "]"
	end
	if core.setting_getbool("show_advanced_settings_menu") then
		tab_string = tab_string ..
		"button[8,4.25;3.75,0.4;btn_hide_advanced_menu;".. fgettext("Hide advanced settings") .. "]"
	else
		tab_string = tab_string ..
		"button[8,4.25;3.75,0.4;btn_show_advanced_menu;".. fgettext("Show advanced settings") .. "]"
	end
	tab_string = tab_string ..
...
local function handle_settings_buttons(this, fields, tabname, tabdata)
	...
	if fields["btn_hide_advanced_menu"] then
		core.setting_setbool("show_advanced_settings_menu",false)
		create_tv_main()
		ui.update()
		return true
	end
	if fields["btn_show_advanced_menu"] then
		core.setting_setbool("show_advanced_settings_menu",true)
		create_tv_main()
		ui.update()
		return true
	end
