...
void OpenGLProcedures::LoadAllProcedures(irr::video::IContextManager *cmgr)
{
	...
	if (!GetPointervKHR) GetPointervKHR = (PFNGLGETPOINTERVPROC_MT)cmgr->getProcAddress("glGetPointervKHR");
	...
	if (!TexImage3DOES) TexImage3DOES = (PFNGLTEXIMAGE3DPROC_MT)cmgr->getProcAddress("glTexImage3DOES");
	if (!TexSubImage3D) TexSubImage3D = (PFNGLTEXSUBIMAGE3DPROC_MT)cmgr->getProcAddress("glTexSubImage3D");
	if (!TexSubImage3DOES) TexSubImage3DOES = (PFNGLTEXSUBIMAGE3DPROC_MT)cmgr->getProcAddress("glTexSubImage3DOES");
	if (!CopyTexSubImage3D) CopyTexSubImage3D = (PFNGLCOPYTEXSUBIMAGE3DPROC_MT)cmgr->getProcAddress("glCopyTexSubImage3D");
	if (!CopyTexSubImage3DOES) CopyTexSubImage3DOES = (PFNGLCOPYTEXSUBIMAGE3DPROC_MT)cmgr->getProcAddress("glCopyTexSubImage3DOES");
	...
	if (!CompressedTexImage3DOES) CompressedTexImage3DOES = (PFNGLCOMPRESSEDTEXIMAGE3DPROC_MT)cmgr->getProcAddress("glCompressedTexImage3DOES");
	...
	if (!CompressedTexSubImage3DOES) CompressedTexSubImage3DOES = (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC_MT)cmgr->getProcAddress("glCompressedTexSubImage3DOES");
	...
	if (!MapBufferOES) MapBufferOES = (PFNGLMAPBUFFERPROC_MT)cmgr->getProcAddress("glMapBufferOES");
	if (!UnmapBuffer) UnmapBuffer = (PFNGLUNMAPBUFFERPROC_MT)cmgr->getProcAddress("glUnmapBuffer");
	if (!UnmapBufferOES) UnmapBufferOES = (PFNGLUNMAPBUFFERPROC_MT)cmgr->getProcAddress("glUnmapBufferOES");
	...
	if (!GetBufferPointervOES) GetBufferPointervOES = (PFNGLGETBUFFERPOINTERVPROC_MT)cmgr->getProcAddress("glGetBufferPointervOES");
	...
	if (!ColorMaskiOES) ColorMaskiOES = (PFNGLCOLORMASKIPROC_MT)cmgr->getProcAddress("glColorMaskiOES");
	if (!Enablei) Enablei = (PFNGLENABLEIPROC_MT)cmgr->getProcAddress("glEnablei");
	if (!EnableiOES) EnableiOES = (PFNGLENABLEIPROC_MT)cmgr->getProcAddress("glEnableiOES");
	if (!Disablei) Disablei = (PFNGLDISABLEIPROC_MT)cmgr->getProcAddress("glDisablei");
	if (!DisableiOES) DisableiOES = (PFNGLDISABLEIPROC_MT)cmgr->getProcAddress("glDisableiOES");
	if (!IsEnabledi) IsEnabledi = (PFNGLISENABLEDIPROC_MT)cmgr->getProcAddress("glIsEnabledi");
	if (!IsEnablediOES) IsEnablediOES = (PFNGLISENABLEDIPROC_MT)cmgr->getProcAddress("glIsEnablediOES");
	...
	if (!TexParameterIivOES) TexParameterIivOES = (PFNGLTEXPARAMETERIIVPROC_MT)cmgr->getProcAddress("glTexParameterIivOES");
	if (!TexParameterIuiv) TexParameterIuiv = (PFNGLTEXPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glTexParameterIuiv");
	if (!TexParameterIuivOES) TexParameterIuivOES = (PFNGLTEXPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glTexParameterIuivOES");
	if (!GetTexParameterIiv) GetTexParameterIiv = (PFNGLGETTEXPARAMETERIIVPROC_MT)cmgr->getProcAddress("glGetTexParameterIiv");
	if (!GetTexParameterIivOES) GetTexParameterIivOES = (PFNGLGETTEXPARAMETERIIVPROC_MT)cmgr->getProcAddress("glGetTexParameterIivOES");
	if (!GetTexParameterIuiv) GetTexParameterIuiv = (PFNGLGETTEXPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glGetTexParameterIuiv");
	if (!GetTexParameterIuivOES) GetTexParameterIuivOES = (PFNGLGETTEXPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glGetTexParameterIuivOES");
	...
	if (!FramebufferTexture3DOES) FramebufferTexture3DOES = (PFNGLFRAMEBUFFERTEXTURE3DPROC_MT)cmgr->getProcAddress("glFramebufferTexture3DOES");
	...
	if (!FramebufferTextureLayerARB) FramebufferTextureLayerARB = (PFNGLFRAMEBUFFERTEXTURELAYERPROC_MT)cmgr->getProcAddress("glFramebufferTextureLayerARB");
	...
	if (!BindVertexArrayOES) BindVertexArrayOES = (PFNGLBINDVERTEXARRAYPROC_MT)cmgr->getProcAddress("glBindVertexArrayOES");
	if (!DeleteVertexArrays) DeleteVertexArrays = (PFNGLDELETEVERTEXARRAYSPROC_MT)cmgr->getProcAddress("glDeleteVertexArrays");
	if (!DeleteVertexArraysOES) DeleteVertexArraysOES = (PFNGLDELETEVERTEXARRAYSPROC_MT)cmgr->getProcAddress("glDeleteVertexArraysOES");
	if (!GenVertexArrays) GenVertexArrays = (PFNGLGENVERTEXARRAYSPROC_MT)cmgr->getProcAddress("glGenVertexArrays");
	if (!GenVertexArraysOES) GenVertexArraysOES = (PFNGLGENVERTEXARRAYSPROC_MT)cmgr->getProcAddress("glGenVertexArraysOES");
	if (!IsVertexArray) IsVertexArray = (PFNGLISVERTEXARRAYPROC_MT)cmgr->getProcAddress("glIsVertexArray");
	if (!IsVertexArrayOES) IsVertexArrayOES = (PFNGLISVERTEXARRAYPROC_MT)cmgr->getProcAddress("glIsVertexArrayOES");
	if (!DrawArraysInstanced) DrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC_MT)cmgr->getProcAddress("glDrawArraysInstanced");
	if (!DrawArraysInstancedARB) DrawArraysInstancedARB = (PFNGLDRAWARRAYSINSTANCEDPROC_MT)cmgr->getProcAddress("glDrawArraysInstancedARB");
	...
	if (!DrawElementsInstancedARB) DrawElementsInstancedARB = (PFNGLDRAWELEMENTSINSTANCEDPROC_MT)cmgr->getProcAddress("glDrawElementsInstancedARB");
	if (!TexBuffer) TexBuffer = (PFNGLTEXBUFFERPROC_MT)cmgr->getProcAddress("glTexBuffer");
	if (!TexBufferARB) TexBufferARB = (PFNGLTEXBUFFERPROC_MT)cmgr->getProcAddress("glTexBufferARB");
	if (!TexBufferOES) TexBufferOES = (PFNGLTEXBUFFERPROC_MT)cmgr->getProcAddress("glTexBufferOES");
	...
	if (!DrawElementsBaseVertexOES) DrawElementsBaseVertexOES = (PFNGLDRAWELEMENTSBASEVERTEXPROC_MT)cmgr->getProcAddress("glDrawElementsBaseVertexOES");
	...
	if (!DrawRangeElementsBaseVertexOES) DrawRangeElementsBaseVertexOES = (PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC_MT)cmgr->getProcAddress("glDrawRangeElementsBaseVertexOES");
	...
	if (!DrawElementsInstancedBaseVertexOES) DrawElementsInstancedBaseVertexOES = (PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC_MT)cmgr->getProcAddress("glDrawElementsInstancedBaseVertexOES");
	...
	if (!FramebufferTextureARB) FramebufferTextureARB = (PFNGLFRAMEBUFFERTEXTUREPROC_MT)cmgr->getProcAddress("glFramebufferTextureARB");
	if (!FramebufferTextureOES) FramebufferTextureOES = (PFNGLFRAMEBUFFERTEXTUREPROC_MT)cmgr->getProcAddress("glFramebufferTextureOES");
	...
	if (!SamplerParameterIivOES) SamplerParameterIivOES = (PFNGLSAMPLERPARAMETERIIVPROC_MT)cmgr->getProcAddress("glSamplerParameterIivOES");
	if (!SamplerParameterIuiv) SamplerParameterIuiv = (PFNGLSAMPLERPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glSamplerParameterIuiv");
	if (!SamplerParameterIuivOES) SamplerParameterIuivOES = (PFNGLSAMPLERPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glSamplerParameterIuivOES");
	...
	if (!GetSamplerParameterIivOES) GetSamplerParameterIivOES = (PFNGLGETSAMPLERPARAMETERIIVPROC_MT)cmgr->getProcAddress("glGetSamplerParameterIivOES");
	...
	if (!GetSamplerParameterIuivOES) GetSamplerParameterIuivOES = (PFNGLGETSAMPLERPARAMETERIUIVPROC_MT)cmgr->getProcAddress("glGetSamplerParameterIuivOES");
	...
	if (!VertexAttribDivisorARB) VertexAttribDivisorARB = (PFNGLVERTEXATTRIBDIVISORPROC_MT)cmgr->getProcAddress("glVertexAttribDivisorARB");
	...
	if (!MinSampleShadingARB) MinSampleShadingARB = (PFNGLMINSAMPLESHADINGPROC_MT)cmgr->getProcAddress("glMinSampleShadingARB");
	if (!MinSampleShadingOES) MinSampleShadingOES = (PFNGLMINSAMPLESHADINGPROC_MT)cmgr->getProcAddress("glMinSampleShadingOES");
	if (!BlendEquationi) BlendEquationi = (PFNGLBLENDEQUATIONIPROC_MT)cmgr->getProcAddress("glBlendEquationi");
	if (!BlendEquationiARB) BlendEquationiARB = (PFNGLBLENDEQUATIONIPROC_MT)cmgr->getProcAddress("glBlendEquationiARB");
	if (!BlendEquationiOES) BlendEquationiOES = (PFNGLBLENDEQUATIONIPROC_MT)cmgr->getProcAddress("glBlendEquationiOES");
	...
	if (!BlendEquationSeparateiARB) BlendEquationSeparateiARB = (PFNGLBLENDEQUATIONSEPARATEIPROC_MT)cmgr->getProcAddress("glBlendEquationSeparateiARB");
	if (!BlendEquationSeparateiOES) BlendEquationSeparateiOES = (PFNGLBLENDEQUATIONSEPARATEIPROC_MT)cmgr->getProcAddress("glBlendEquationSeparateiOES");
	if (!BlendFunci) BlendFunci = (PFNGLBLENDFUNCIPROC_MT)cmgr->getProcAddress("glBlendFunci");
	if (!BlendFunciARB) BlendFunciARB = (PFNGLBLENDFUNCIPROC_MT)cmgr->getProcAddress("glBlendFunciARB");
	if (!BlendFunciOES) BlendFunciOES = (PFNGLBLENDFUNCIPROC_MT)cmgr->getProcAddress("glBlendFunciOES");
	if (!BlendFuncSeparatei) BlendFuncSeparatei = (PFNGLBLENDFUNCSEPARATEIPROC_MT)cmgr->getProcAddress("glBlendFuncSeparatei");
	if (!BlendFuncSeparateiARB) BlendFuncSeparateiARB = (PFNGLBLENDFUNCSEPARATEIPROC_MT)cmgr->getProcAddress("glBlendFuncSeparateiARB");
	if (!BlendFuncSeparateiOES) BlendFuncSeparateiOES = (PFNGLBLENDFUNCSEPARATEIPROC_MT)cmgr->getProcAddress("glBlendFuncSeparateiOES");
	...
	if (!PatchParameteriOES) PatchParameteriOES = (PFNGLPATCHPARAMETERIPROC_MT)cmgr->getProcAddress("glPatchParameteriOES");
	...
	if (!GetProgramBinaryOES) GetProgramBinaryOES = (PFNGLGETPROGRAMBINARYPROC_MT)cmgr->getProcAddress("glGetProgramBinaryOES");
	if (!ProgramBinary) ProgramBinary = (PFNGLPROGRAMBINARYPROC_MT)cmgr->getProcAddress("glProgramBinary");
	if (!ProgramBinaryOES) ProgramBinaryOES = (PFNGLPROGRAMBINARYPROC_MT)cmgr->getProcAddress("glProgramBinaryOES");
	if (!ProgramParameteri) ProgramParameteri = (PFNGLPROGRAMPARAMETERIPROC_MT)cmgr->getProcAddress("glProgramParameteri");
	if (!ProgramParameteriARB) ProgramParameteriARB = (PFNGLPROGRAMPARAMETERIPROC_MT)cmgr->getProcAddress("glProgramParameteriARB");
	...
	if (!ViewportArrayvOES) ViewportArrayvOES = (PFNGLVIEWPORTARRAYVPROC_MT)cmgr->getProcAddress("glViewportArrayvOES");
	if (!ViewportIndexedf) ViewportIndexedf = (PFNGLVIEWPORTINDEXEDFPROC_MT)cmgr->getProcAddress("glViewportIndexedf");
	if (!ViewportIndexedfOES) ViewportIndexedfOES = (PFNGLVIEWPORTINDEXEDFPROC_MT)cmgr->getProcAddress("glViewportIndexedfOES");
	if (!ViewportIndexedfv) ViewportIndexedfv = (PFNGLVIEWPORTINDEXEDFVPROC_MT)cmgr->getProcAddress("glViewportIndexedfv");
	if (!ViewportIndexedfvOES) ViewportIndexedfvOES = (PFNGLVIEWPORTINDEXEDFVPROC_MT)cmgr->getProcAddress("glViewportIndexedfvOES");
	if (!ScissorArrayv) ScissorArrayv = (PFNGLSCISSORARRAYVPROC_MT)cmgr->getProcAddress("glScissorArrayv");
	if (!ScissorArrayvOES) ScissorArrayvOES = (PFNGLSCISSORARRAYVPROC_MT)cmgr->getProcAddress("glScissorArrayvOES");
	if (!ScissorIndexed) ScissorIndexed = (PFNGLSCISSORINDEXEDPROC_MT)cmgr->getProcAddress("glScissorIndexed");
	if (!ScissorIndexedOES) ScissorIndexedOES = (PFNGLSCISSORINDEXEDPROC_MT)cmgr->getProcAddress("glScissorIndexedOES");
	if (!ScissorIndexedv) ScissorIndexedv = (PFNGLSCISSORINDEXEDVPROC_MT)cmgr->getProcAddress("glScissorIndexedv");
	if (!ScissorIndexedvOES) ScissorIndexedvOES = (PFNGLSCISSORINDEXEDVPROC_MT)cmgr->getProcAddress("glScissorIndexedvOES");
	...
	if (!CopyImageSubDataOES) CopyImageSubDataOES = (PFNGLCOPYIMAGESUBDATAPROC_MT)cmgr->getProcAddress("glCopyImageSubDataOES");
	...
	if (!TexBufferRangeOES) TexBufferRangeOES = (PFNGLTEXBUFFERRANGEPROC_MT)cmgr->getProcAddress("glTexBufferRangeOES");
	...
	if (!TexStorage3DMultisampleOES) TexStorage3DMultisampleOES = (PFNGLTEXSTORAGE3DMULTISAMPLEPROC_MT)cmgr->getProcAddress("glTexStorage3DMultisampleOES");
	if (!TextureView) TextureView = (PFNGLTEXTUREVIEWPROC_MT)cmgr->getProcAddress("glTextureView");
	if (!TextureViewOES) TextureViewOES = (PFNGLTEXTUREVIEWPROC_MT)cmgr->getProcAddress("glTextureViewOES");
	...
	if (!DebugMessageControlARB) DebugMessageControlARB = (PFNGLDEBUGMESSAGECONTROLPROC_MT)cmgr->getProcAddress("glDebugMessageControlARB");
	if (!DebugMessageControlKHR) DebugMessageControlKHR = (PFNGLDEBUGMESSAGECONTROLPROC_MT)cmgr->getProcAddress("glDebugMessageControlKHR");
	if (!DebugMessageInsert) DebugMessageInsert = (PFNGLDEBUGMESSAGEINSERTPROC_MT)cmgr->getProcAddress("glDebugMessageInsert");
	if (!DebugMessageInsertARB) DebugMessageInsertARB = (PFNGLDEBUGMESSAGEINSERTPROC_MT)cmgr->getProcAddress("glDebugMessageInsertARB");
	if (!DebugMessageInsertKHR) DebugMessageInsertKHR = (PFNGLDEBUGMESSAGEINSERTPROC_MT)cmgr->getProcAddress("glDebugMessageInsertKHR");
	if (!DebugMessageCallback) DebugMessageCallback = (PFNGLDEBUGMESSAGECALLBACKPROC_MT)cmgr->getProcAddress("glDebugMessageCallback");
	if (!DebugMessageCallbackARB) DebugMessageCallbackARB = (PFNGLDEBUGMESSAGECALLBACKPROC_MT)cmgr->getProcAddress("glDebugMessageCallbackARB");
	if (!DebugMessageCallbackKHR) DebugMessageCallbackKHR = (PFNGLDEBUGMESSAGECALLBACKPROC_MT)cmgr->getProcAddress("glDebugMessageCallbackKHR");
	if (!GetDebugMessageLog) GetDebugMessageLog = (PFNGLGETDEBUGMESSAGELOGPROC_MT)cmgr->getProcAddress("glGetDebugMessageLog");
	if (!GetDebugMessageLogARB) GetDebugMessageLogARB = (PFNGLGETDEBUGMESSAGELOGPROC_MT)cmgr->getProcAddress("glGetDebugMessageLogARB");
	if (!GetDebugMessageLogKHR) GetDebugMessageLogKHR = (PFNGLGETDEBUGMESSAGELOGPROC_MT)cmgr->getProcAddress("glGetDebugMessageLogKHR");
	if (!PushDebugGroup) PushDebugGroup = (PFNGLPUSHDEBUGGROUPPROC_MT)cmgr->getProcAddress("glPushDebugGroup");
	if (!PushDebugGroupKHR) PushDebugGroupKHR = (PFNGLPUSHDEBUGGROUPPROC_MT)cmgr->getProcAddress("glPushDebugGroupKHR");
	if (!PopDebugGroup) PopDebugGroup = (PFNGLPOPDEBUGGROUPPROC_MT)cmgr->getProcAddress("glPopDebugGroup");
	if (!PopDebugGroupKHR) PopDebugGroupKHR = (PFNGLPOPDEBUGGROUPPROC_MT)cmgr->getProcAddress("glPopDebugGroupKHR");
	if (!ObjectLabel) ObjectLabel = (PFNGLOBJECTLABELPROC_MT)cmgr->getProcAddress("glObjectLabel");
	if (!ObjectLabelKHR) ObjectLabelKHR = (PFNGLOBJECTLABELPROC_MT)cmgr->getProcAddress("glObjectLabelKHR");
	if (!GetObjectLabel) GetObjectLabel = (PFNGLGETOBJECTLABELPROC_MT)cmgr->getProcAddress("glGetObjectLabel");
	if (!GetObjectLabelKHR) GetObjectLabelKHR = (PFNGLGETOBJECTLABELPROC_MT)cmgr->getProcAddress("glGetObjectLabelKHR");
	if (!ObjectPtrLabel) ObjectPtrLabel = (PFNGLOBJECTPTRLABELPROC_MT)cmgr->getProcAddress("glObjectPtrLabel");
	if (!ObjectPtrLabelKHR) ObjectPtrLabelKHR = (PFNGLOBJECTPTRLABELPROC_MT)cmgr->getProcAddress("glObjectPtrLabelKHR");
	if (!GetObjectPtrLabel) GetObjectPtrLabel = (PFNGLGETOBJECTPTRLABELPROC_MT)cmgr->getProcAddress("glGetObjectPtrLabel");
	if (!GetObjectPtrLabelKHR) GetObjectPtrLabelKHR = (PFNGLGETOBJECTPTRLABELPROC_MT)cmgr->getProcAddress("glGetObjectPtrLabelKHR");
	...
	if (!GetGraphicsResetStatusARB) GetGraphicsResetStatusARB = (PFNGLGETGRAPHICSRESETSTATUSPROC_MT)cmgr->getProcAddress("glGetGraphicsResetStatusARB");
	if (!GetGraphicsResetStatusKHR) GetGraphicsResetStatusKHR = (PFNGLGETGRAPHICSRESETSTATUSPROC_MT)cmgr->getProcAddress("glGetGraphicsResetStatusKHR");
	...
	if (!GetnCompressedTexImageARB) GetnCompressedTexImageARB = (PFNGLGETNCOMPRESSEDTEXIMAGEPROC_MT)cmgr->getProcAddress("glGetnCompressedTexImageARB");
	if (!GetnTexImage) GetnTexImage = (PFNGLGETNTEXIMAGEPROC_MT)cmgr->getProcAddress("glGetnTexImage");
	if (!GetnTexImageARB) GetnTexImageARB = (PFNGLGETNTEXIMAGEPROC_MT)cmgr->getProcAddress("glGetnTexImageARB");
	if (!GetnUniformdv) GetnUniformdv = (PFNGLGETNUNIFORMDVPROC_MT)cmgr->getProcAddress("glGetnUniformdv");
	if (!GetnUniformdvARB) GetnUniformdvARB = (PFNGLGETNUNIFORMDVPROC_MT)cmgr->getProcAddress("glGetnUniformdvARB");
	if (!GetnUniformfv) GetnUniformfv = (PFNGLGETNUNIFORMFVPROC_MT)cmgr->getProcAddress("glGetnUniformfv");
	if (!GetnUniformfvARB) GetnUniformfvARB = (PFNGLGETNUNIFORMFVPROC_MT)cmgr->getProcAddress("glGetnUniformfvARB");
	if (!GetnUniformfvKHR) GetnUniformfvKHR = (PFNGLGETNUNIFORMFVPROC_MT)cmgr->getProcAddress("glGetnUniformfvKHR");
	if (!GetnUniformiv) GetnUniformiv = (PFNGLGETNUNIFORMIVPROC_MT)cmgr->getProcAddress("glGetnUniformiv");
	if (!GetnUniformivARB) GetnUniformivARB = (PFNGLGETNUNIFORMIVPROC_MT)cmgr->getProcAddress("glGetnUniformivARB");
	if (!GetnUniformivKHR) GetnUniformivKHR = (PFNGLGETNUNIFORMIVPROC_MT)cmgr->getProcAddress("glGetnUniformivKHR");
	if (!GetnUniformuiv) GetnUniformuiv = (PFNGLGETNUNIFORMUIVPROC_MT)cmgr->getProcAddress("glGetnUniformuiv");
	if (!GetnUniformuivARB) GetnUniformuivARB = (PFNGLGETNUNIFORMUIVPROC_MT)cmgr->getProcAddress("glGetnUniformuivARB");
	if (!GetnUniformuivKHR) GetnUniformuivKHR = (PFNGLGETNUNIFORMUIVPROC_MT)cmgr->getProcAddress("glGetnUniformuivKHR");
	if (!ReadnPixels) ReadnPixels = (PFNGLREADNPIXELSPROC_MT)cmgr->getProcAddress("glReadnPixels");
	if (!ReadnPixelsARB) ReadnPixelsARB = (PFNGLREADNPIXELSPROC_MT)cmgr->getProcAddress("glReadnPixelsARB");
	if (!ReadnPixelsKHR) ReadnPixelsKHR = (PFNGLREADNPIXELSPROC_MT)cmgr->getProcAddress("glReadnPixelsKHR");
	...
	if (!SpecializeShaderARB) SpecializeShaderARB = (PFNGLSPECIALIZESHADERPROC_MT)cmgr->getProcAddress("glSpecializeShaderARB");
	...
	if (!MultiDrawArraysIndirectCountARB) MultiDrawArraysIndirectCountARB = (PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC_MT)cmgr->getProcAddress("glMultiDrawArraysIndirectCountARB");
	...
	if (!MultiDrawElementsIndirectCountARB) MultiDrawElementsIndirectCountARB = (PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC_MT)cmgr->getProcAddress("glMultiDrawElementsIndirectCountARB");
	...
	if (!PrimitiveBoundingBoxARB) PrimitiveBoundingBoxARB = (PFNGLPRIMITIVEBOUNDINGBOXPROC_MT)cmgr->getProcAddress("glPrimitiveBoundingBoxARB");
	if (!PrimitiveBoundingBoxOES) PrimitiveBoundingBoxOES = (PFNGLPRIMITIVEBOUNDINGBOXPROC_MT)cmgr->getProcAddress("glPrimitiveBoundingBoxOES");
	if (!GetTextureHandleARB) GetTextureHandleARB = (PFNGLGETTEXTUREHANDLEPROC_MT)cmgr->getProcAddress("glGetTextureHandleARB");
	if (!GetTextureSamplerHandleARB) GetTextureSamplerHandleARB = (PFNGLGETTEXTURESAMPLERHANDLEPROC_MT)cmgr->getProcAddress("glGetTextureSamplerHandleARB");
	if (!MakeTextureHandleResidentARB) MakeTextureHandleResidentARB = (PFNGLMAKETEXTUREHANDLERESIDENTPROC_MT)cmgr->getProcAddress("glMakeTextureHandleResidentARB");
	if (!MakeTextureHandleNonResidentARB) MakeTextureHandleNonResidentARB = (PFNGLMAKETEXTUREHANDLENONRESIDENTPROC_MT)cmgr->getProcAddress("glMakeTextureHandleNonResidentARB");
	if (!GetImageHandleARB) GetImageHandleARB = (PFNGLGETIMAGEHANDLEPROC_MT)cmgr->getProcAddress("glGetImageHandleARB");
	if (!MakeImageHandleResidentARB) MakeImageHandleResidentARB = (PFNGLMAKEIMAGEHANDLERESIDENTPROC_MT)cmgr->getProcAddress("glMakeImageHandleResidentARB");
	if (!MakeImageHandleNonResidentARB) MakeImageHandleNonResidentARB = (PFNGLMAKEIMAGEHANDLENONRESIDENTPROC_MT)cmgr->getProcAddress("glMakeImageHandleNonResidentARB");
	if (!UniformHandleui64ARB) UniformHandleui64ARB = (PFNGLUNIFORMHANDLEUI64PROC_MT)cmgr->getProcAddress("glUniformHandleui64ARB");
	if (!UniformHandleui64vARB) UniformHandleui64vARB = (PFNGLUNIFORMHANDLEUI64VPROC_MT)cmgr->getProcAddress("glUniformHandleui64vARB");
	if (!ProgramUniformHandleui64ARB) ProgramUniformHandleui64ARB = (PFNGLPROGRAMUNIFORMHANDLEUI64PROC_MT)cmgr->getProcAddress("glProgramUniformHandleui64ARB");
	if (!ProgramUniformHandleui64vARB) ProgramUniformHandleui64vARB = (PFNGLPROGRAMUNIFORMHANDLEUI64VPROC_MT)cmgr->getProcAddress("glProgramUniformHandleui64vARB");
	if (!IsTextureHandleResidentARB) IsTextureHandleResidentARB = (PFNGLISTEXTUREHANDLERESIDENTPROC_MT)cmgr->getProcAddress("glIsTextureHandleResidentARB");
	if (!IsImageHandleResidentARB) IsImageHandleResidentARB = (PFNGLISIMAGEHANDLERESIDENTPROC_MT)cmgr->getProcAddress("glIsImageHandleResidentARB");
	if (!VertexAttribL1ui64ARB) VertexAttribL1ui64ARB = (PFNGLVERTEXATTRIBL1UI64PROC_MT)cmgr->getProcAddress("glVertexAttribL1ui64ARB");
	if (!VertexAttribL1ui64vARB) VertexAttribL1ui64vARB = (PFNGLVERTEXATTRIBL1UI64VPROC_MT)cmgr->getProcAddress("glVertexAttribL1ui64vARB");
	if (!GetVertexAttribLui64vARB) GetVertexAttribLui64vARB = (PFNGLGETVERTEXATTRIBLUI64VPROC_MT)cmgr->getProcAddress("glGetVertexAttribLui64vARB");
	if (!CreateSyncFromCLeventARB) CreateSyncFromCLeventARB = (PFNGLCREATESYNCFROMCLEVENTPROC_MT)cmgr->getProcAddress("glCreateSyncFromCLeventARB");
	if (!DispatchComputeGroupSizeARB) DispatchComputeGroupSizeARB = (PFNGLDISPATCHCOMPUTEGROUPSIZEPROC_MT)cmgr->getProcAddress("glDispatchComputeGroupSizeARB");
	if (!FramebufferTextureFaceARB) FramebufferTextureFaceARB = (PFNGLFRAMEBUFFERTEXTUREFACEPROC_MT)cmgr->getProcAddress("glFramebufferTextureFaceARB");
	if (!Uniform1i64ARB) Uniform1i64ARB = (PFNGLUNIFORM1I64PROC_MT)cmgr->getProcAddress("glUniform1i64ARB");
	if (!Uniform2i64ARB) Uniform2i64ARB = (PFNGLUNIFORM2I64PROC_MT)cmgr->getProcAddress("glUniform2i64ARB");
	if (!Uniform3i64ARB) Uniform3i64ARB = (PFNGLUNIFORM3I64PROC_MT)cmgr->getProcAddress("glUniform3i64ARB");
	if (!Uniform4i64ARB) Uniform4i64ARB = (PFNGLUNIFORM4I64PROC_MT)cmgr->getProcAddress("glUniform4i64ARB");
	if (!Uniform1i64vARB) Uniform1i64vARB = (PFNGLUNIFORM1I64VPROC_MT)cmgr->getProcAddress("glUniform1i64vARB");
	if (!Uniform2i64vARB) Uniform2i64vARB = (PFNGLUNIFORM2I64VPROC_MT)cmgr->getProcAddress("glUniform2i64vARB");
	if (!Uniform3i64vARB) Uniform3i64vARB = (PFNGLUNIFORM3I64VPROC_MT)cmgr->getProcAddress("glUniform3i64vARB");
	if (!Uniform4i64vARB) Uniform4i64vARB = (PFNGLUNIFORM4I64VPROC_MT)cmgr->getProcAddress("glUniform4i64vARB");
	if (!Uniform1ui64ARB) Uniform1ui64ARB = (PFNGLUNIFORM1UI64PROC_MT)cmgr->getProcAddress("glUniform1ui64ARB");
	if (!Uniform2ui64ARB) Uniform2ui64ARB = (PFNGLUNIFORM2UI64PROC_MT)cmgr->getProcAddress("glUniform2ui64ARB");
	if (!Uniform3ui64ARB) Uniform3ui64ARB = (PFNGLUNIFORM3UI64PROC_MT)cmgr->getProcAddress("glUniform3ui64ARB");
	if (!Uniform4ui64ARB) Uniform4ui64ARB = (PFNGLUNIFORM4UI64PROC_MT)cmgr->getProcAddress("glUniform4ui64ARB");
	if (!Uniform1ui64vARB) Uniform1ui64vARB = (PFNGLUNIFORM1UI64VPROC_MT)cmgr->getProcAddress("glUniform1ui64vARB");
	if (!Uniform2ui64vARB) Uniform2ui64vARB = (PFNGLUNIFORM2UI64VPROC_MT)cmgr->getProcAddress("glUniform2ui64vARB");
	if (!Uniform3ui64vARB) Uniform3ui64vARB = (PFNGLUNIFORM3UI64VPROC_MT)cmgr->getProcAddress("glUniform3ui64vARB");
	if (!Uniform4ui64vARB) Uniform4ui64vARB = (PFNGLUNIFORM4UI64VPROC_MT)cmgr->getProcAddress("glUniform4ui64vARB");
	if (!GetUniformi64vARB) GetUniformi64vARB = (PFNGLGETUNIFORMI64VPROC_MT)cmgr->getProcAddress("glGetUniformi64vARB");
	if (!GetUniformui64vARB) GetUniformui64vARB = (PFNGLGETUNIFORMUI64VPROC_MT)cmgr->getProcAddress("glGetUniformui64vARB");
	if (!GetnUniformi64vARB) GetnUniformi64vARB = (PFNGLGETNUNIFORMI64VPROC_MT)cmgr->getProcAddress("glGetnUniformi64vARB");
	if (!GetnUniformui64vARB) GetnUniformui64vARB = (PFNGLGETNUNIFORMUI64VPROC_MT)cmgr->getProcAddress("glGetnUniformui64vARB");
	if (!ProgramUniform1i64ARB) ProgramUniform1i64ARB = (PFNGLPROGRAMUNIFORM1I64PROC_MT)cmgr->getProcAddress("glProgramUniform1i64ARB");
	if (!ProgramUniform2i64ARB) ProgramUniform2i64ARB = (PFNGLPROGRAMUNIFORM2I64PROC_MT)cmgr->getProcAddress("glProgramUniform2i64ARB");
	if (!ProgramUniform3i64ARB) ProgramUniform3i64ARB = (PFNGLPROGRAMUNIFORM3I64PROC_MT)cmgr->getProcAddress("glProgramUniform3i64ARB");
	if (!ProgramUniform4i64ARB) ProgramUniform4i64ARB = (PFNGLPROGRAMUNIFORM4I64PROC_MT)cmgr->getProcAddress("glProgramUniform4i64ARB");
	if (!ProgramUniform1i64vARB) ProgramUniform1i64vARB = (PFNGLPROGRAMUNIFORM1I64VPROC_MT)cmgr->getProcAddress("glProgramUniform1i64vARB");
	if (!ProgramUniform2i64vARB) ProgramUniform2i64vARB = (PFNGLPROGRAMUNIFORM2I64VPROC_MT)cmgr->getProcAddress("glProgramUniform2i64vARB");
	if (!ProgramUniform3i64vARB) ProgramUniform3i64vARB = (PFNGLPROGRAMUNIFORM3I64VPROC_MT)cmgr->getProcAddress("glProgramUniform3i64vARB");
	if (!ProgramUniform4i64vARB) ProgramUniform4i64vARB = (PFNGLPROGRAMUNIFORM4I64VPROC_MT)cmgr->getProcAddress("glProgramUniform4i64vARB");
	if (!ProgramUniform1ui64ARB) ProgramUniform1ui64ARB = (PFNGLPROGRAMUNIFORM1UI64PROC_MT)cmgr->getProcAddress("glProgramUniform1ui64ARB");
	if (!ProgramUniform2ui64ARB) ProgramUniform2ui64ARB = (PFNGLPROGRAMUNIFORM2UI64PROC_MT)cmgr->getProcAddress("glProgramUniform2ui64ARB");
	if (!ProgramUniform3ui64ARB) ProgramUniform3ui64ARB = (PFNGLPROGRAMUNIFORM3UI64PROC_MT)cmgr->getProcAddress("glProgramUniform3ui64ARB");
	if (!ProgramUniform4ui64ARB) ProgramUniform4ui64ARB = (PFNGLPROGRAMUNIFORM4UI64PROC_MT)cmgr->getProcAddress("glProgramUniform4ui64ARB");
	if (!ProgramUniform1ui64vARB) ProgramUniform1ui64vARB = (PFNGLPROGRAMUNIFORM1UI64VPROC_MT)cmgr->getProcAddress("glProgramUniform1ui64vARB");
	if (!ProgramUniform2ui64vARB) ProgramUniform2ui64vARB = (PFNGLPROGRAMUNIFORM2UI64VPROC_MT)cmgr->getProcAddress("glProgramUniform2ui64vARB");
	if (!ProgramUniform3ui64vARB) ProgramUniform3ui64vARB = (PFNGLPROGRAMUNIFORM3UI64VPROC_MT)cmgr->getProcAddress("glProgramUniform3ui64vARB");
	if (!ProgramUniform4ui64vARB) ProgramUniform4ui64vARB = (PFNGLPROGRAMUNIFORM4UI64VPROC_MT)cmgr->getProcAddress("glProgramUniform4ui64vARB");
	if (!MaxShaderCompilerThreadsARB) MaxShaderCompilerThreadsARB = (PFNGLMAXSHADERCOMPILERTHREADSPROC_MT)cmgr->getProcAddress("glMaxShaderCompilerThreadsARB");
	if (!MaxShaderCompilerThreadsKHR) MaxShaderCompilerThreadsKHR = (PFNGLMAXSHADERCOMPILERTHREADSPROC_MT)cmgr->getProcAddress("glMaxShaderCompilerThreadsKHR");
	if (!FramebufferSampleLocationsfvARB) FramebufferSampleLocationsfvARB = (PFNGLFRAMEBUFFERSAMPLELOCATIONSFVPROC_MT)cmgr->getProcAddress("glFramebufferSampleLocationsfvARB");
	if (!NamedFramebufferSampleLocationsfvARB) NamedFramebufferSampleLocationsfvARB = (PFNGLNAMEDFRAMEBUFFERSAMPLELOCATIONSFVPROC_MT)cmgr->getProcAddress("glNamedFramebufferSampleLocationsfvARB");
	if (!EvaluateDepthValuesARB) EvaluateDepthValuesARB = (PFNGLEVALUATEDEPTHVALUESPROC_MT)cmgr->getProcAddress("glEvaluateDepthValuesARB");
	if (!NamedStringARB) NamedStringARB = (PFNGLNAMEDSTRINGPROC_MT)cmgr->getProcAddress("glNamedStringARB");
	if (!DeleteNamedStringARB) DeleteNamedStringARB = (PFNGLDELETENAMEDSTRINGPROC_MT)cmgr->getProcAddress("glDeleteNamedStringARB");
	if (!CompileShaderIncludeARB) CompileShaderIncludeARB = (PFNGLCOMPILESHADERINCLUDEPROC_MT)cmgr->getProcAddress("glCompileShaderIncludeARB");
	if (!IsNamedStringARB) IsNamedStringARB = (PFNGLISNAMEDSTRINGPROC_MT)cmgr->getProcAddress("glIsNamedStringARB");
	if (!GetNamedStringARB) GetNamedStringARB = (PFNGLGETNAMEDSTRINGPROC_MT)cmgr->getProcAddress("glGetNamedStringARB");
	if (!GetNamedStringivARB) GetNamedStringivARB = (PFNGLGETNAMEDSTRINGIVPROC_MT)cmgr->getProcAddress("glGetNamedStringivARB");
	if (!BufferPageCommitmentARB) BufferPageCommitmentARB = (PFNGLBUFFERPAGECOMMITMENTPROC_MT)cmgr->getProcAddress("glBufferPageCommitmentARB");
	if (!NamedBufferPageCommitmentARB) NamedBufferPageCommitmentARB = (PFNGLNAMEDBUFFERPAGECOMMITMENTPROC_MT)cmgr->getProcAddress("glNamedBufferPageCommitmentARB");
	if (!TexPageCommitmentARB) TexPageCommitmentARB = (PFNGLTEXPAGECOMMITMENTPROC_MT)cmgr->getProcAddress("glTexPageCommitmentARB");
